...
#    url(r'^$', views.course_main_page, name='course_main_page'),
    ...
    url(r'^trainers/matteo_chiara$', views.trainer, {'trainer_name':'matteo_chiara', 'cn':'10'}, name='matteo_chiara'),
    url(r'^trainers/gianmauro_cuccuru$', views.trainer, {'trainer_name':'gianmauro_cuccuru', 'cn':'10'}, name='gianmauro_cuccuru'),
    ...
    url(r'^trainers/giuseppe_profiti$', views.trainer, {'trainer_name':'giuseppe_profiti', 'cn':'10'}, name='giuseppe_profiti'),
    url(r'^trainers/paolo_uva$', views.trainer, {'trainer_name':'paolo_uva', 'cn':'10'}, name='paolo_uva'),
